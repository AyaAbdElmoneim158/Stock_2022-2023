...
class _TestPageState extends State<TestPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      colors: const [Colors.white, primaryColor, secondColor],
      itemBuilder: (index) {
        ...
        return Column(
          ...
          children: [
            FadeInUp(
                ...
                child: Image.network(pages[pageIndex]['image'], width: 300)),
            Padding(
